...
public interface IFoodInventoryController
{
    ...
    Task<IActionResult> UpdateFood([FromQuery] int id, [FromBody] FoodDto food);
}
...
public class FoodInventoryController : BaseApiController<IFoodInventoryController>, IFoodInventoryController
{
    ...
    [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(IList<FoodDto>))] // TODO: Add elsewhere
    ...
    [HttpPost]
    [ApiVersion("1.0")]
    public async Task<IActionResult> UpdateFood([FromQuery] int id, [FromBody] FoodDto food)
    {
        try
        {
